...
final class CustomerContext implements Context
{
     ...
     */
    public function trustpilotDisabledForCustomer(?CustomerTrustpilotAwareInterface $customer = null): void
    {
        if (null === $customer) {
     ...
     */
    public function trustpilotEnabledForCustomer(?CustomerTrustpilotAwareInterface $customer = null): void
    {
        if (null === $customer) {
            $customer = $this->sharedStorage->get('customer');
            Assert::notNull($customer, 'Customer was not found at shared storage');
